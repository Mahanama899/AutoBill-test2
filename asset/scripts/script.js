...
const deleteProducts = async() => {
    url = 'https://sea-lion-app-fkt2d.ondigitalocean.app/product';
    ...
    for (let product of products) {
        const response = await axios.delete(`https://sea-lion-app-fkt2d.ondigitalocean.app/product/${product.id}`)
